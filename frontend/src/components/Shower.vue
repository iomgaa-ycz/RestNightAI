<template>
        <a-flex :style="{ ...boxStyle }" justify="center" align="center" gap="large">
                <a-card title="轮次" :bordered="false" style="width: 25%; height: 150px">
                    <p style="text-align: center; font-size: 20px">{{epoch}}</p>
                </a-card>
                <a-card title="动作" :bordered="false" style="width: 25%; height: 150px;">
                    <p style="text-align: center; font-size: 20px">{{props.action}}</p>
                </a-card>
                <a-card title="倒计时" :bordered="false" style="width: 25%; height: 150px;">
